...
CREATE TABLE survey (
    ...
    write_date      Date            NOT NULL, -- 최근 작성일자
...
COMMENT ON COLUMN survey.write_date is '최근 작성일자'; 
...
VALUES(survey_seq.nextval, '상위 3개의 팀 추천 설문조사', 1, '2024-12-01', '2024-12-02', 3, '한국인이 있는 팀이 좋습니까?', sysdate);