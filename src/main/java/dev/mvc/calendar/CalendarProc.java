...
public class CalendarProc implements CalendarProcInter {
  ...
  public ArrayList<CalendarVO> list_search_paging(String word, int now_page, int record_per_page) {
    ...
    ArrayList<CalendarVO> list = this.calendarDAO.list_search_paging(map);
...
//    str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
  ...
  public ArrayList<CalendarVO> list_search(String word) {
    ArrayList<CalendarVO> list = this.calendarDAO.list_search(word);
    return list;
  }  
  
  @Override
  public Integer list_search_count(String word) {
    int cnt = this.calendarDAO.list_search_count(word);
    return cnt;
  }
