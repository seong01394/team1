...
-- 조회
SELECT newsno, newsadd, newsinfo, clubno FROM news ORDER BY newsno;
...
-- 수정
UPDATE news SET newsadd='https://www.premierleague.com/news/4193964', newsinfo = '10명으로 풀럼을 상대하고 있는 리버풀을 구한 조타', clubno='1' WHERE newsno =2; 
