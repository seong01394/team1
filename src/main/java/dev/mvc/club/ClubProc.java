...
public class ClubProc implements ClubProcInter {
  ...
  public ArrayList<ClubVO> list_search(String word) {
    ArrayList<ClubVO> list = this.clubDAO.list_search(word);
  ...
  public Integer list_search_count(String word) {
    int cnt = this.clubDAO.list_search_count(word);
    return cnt;
  }
  ...
  public ArrayList<ClubVO> list_search_paging(String word, int now_page, int record_per_page) {
    ...
    ArrayList<ClubVO> list = this.clubDAO.list_search_paging(map);
