...
COMMENT ON COLUMN commu.HASHTAG is '해시태그';
...
-- 조회
SELECT communo, clubno, memberno, headline, contents, recom, reply, viewcnt, hashtag, rdate, commuthumb, image, imagesaved, imagesize FROM commu ORDER BY communo;
