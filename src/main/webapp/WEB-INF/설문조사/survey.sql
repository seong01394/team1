...
INSERT INTO survey(surveyno, survey_title, seqno, start_date, fin_date, qa_num, qa_contents, write_date, selectno, adminno, memberno)
VALUES(survey_seq.nextval, '상위 3개의 팀 추천 설문조사', 1, '2024-12-01', '2024-12-30', 3, '한국인이 있는 팀이 좋습니까?', sysdate, 1, 1, 1);

- 목록
select surveyno, survey_title, seqno, start_date, fin_date, qa_num, qa_contents, write_date, selectno, adminno, memberno FROM survey ORDER BY surveyno ASC;